...
export default function FeedCardSkeleton() {
  return (
    <Card className="bg-slate-800/50 border-slate-700 hover:border-slate-600 transition-colors animate-pulse">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <Skeleton className="h-4 w-6 rounded bg-slate-700" />
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <Skeleton className="h-3 w-16 rounded bg-slate-700" />
                <Skeleton className="h-3 w-3 rounded-full bg-slate-700" />
                <Skeleton className="h-3 w-20 rounded bg-slate-700" />
              </div>
            </div>
      ...
      <CardContent className="pt-0">
        {/* Post Content */}
        <Skeleton className="h-4 w-full mb-2 rounded bg-slate-700" />
        <Skeleton className="h-4 w-5/6 mb-2 rounded bg-slate-700" />
        <Skeleton className="h-4 w-2/3 mb-4 rounded bg-slate-700" />
        {/* Post Image */}
