      ...
      captionOverlay={
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="mx-auto w-full max-w-[560px] md:mx-0"
          >
            <div className="relative overflow-hidden rounded-[28px] border border-white/15 bg-slate-950/96 p-4 text-center shadow-[0_24px_80px_rgba(2,6,23,0.78)] ring-1 ring-black/35 backdrop-blur-xl sm:p-5 md:text-left">
              ...
              <div className="pointer-events-none absolute inset-y-0 right-0 w-24 bg-cyan-400/8 blur-2xl" />
