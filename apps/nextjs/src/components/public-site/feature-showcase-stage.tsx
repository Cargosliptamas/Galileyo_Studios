  ...
  return (
    <div
      className={cn(
        ...
        "relative min-h-screen overflow-hidden bg-[#050a11] text-white",
      )}
      style={themeStyle}
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        <header className="hidden border-b border-white/10 bg-slate-950/55 backdrop-blur-xl md:block">
          <div className="mx-auto flex max-w-[1600px] flex-col gap-4 px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-3 sm:grid-cols-1 sm:items-center">
        ...
        <main className="relative flex-1 px-0 py-0 md:px-4 md:py-4 lg:px-8">
          <div className="mx-auto h-[100svh] max-w-[1600px] md:h-[calc(100svh-8.5rem)]">
            <div className="relative flex h-full items-center justify-center">
              <motion.div
                className="relative h-full w-full overflow-hidden rounded-none border-0 bg-slate-950/70 backdrop-blur-md md:rounded-[34px] md:border md:border-[var(--showcase-frame)] md:shadow-[0_40px_160px_rgba(2,6,23,0.7)]"
                style={{
                  boxShadow:
                    "inset 0 1px 0 rgba(255,255,255,0.08), 0 40px 160px rgba(2, 6, 23, 0.7)",
                }}
              >
                <div className="pointer-events-none absolute inset-0 hidden rounded-[34px] border border-[var(--showcase-frame-soft)] md:block" />
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 z-30 p-4 sm:p-6 lg:p-8">
                  {captionOverlay}
                </div>
              </motion.div>
            </div>
