...
import { cn as cx } from "@galileyo/ui";
  ...
  return (
    ...
    >
      <div
        ...
        className={cx(
          "absolute left-0 top-0 flex origin-top-left flex-col justify-between overflow-hidden rounded-2xl p-4",
          styles[type].root,
        )}
      >
        {/* Horizontal strip */}
        ...
        <div className="relative flex items-end justify-between gap-3">
          <div className="flex min-w-0 flex-col gap-2">
            ...
            <div
              className={cx(
                "text-md font-semibold tabular-nums leading-[normal] tracking-[1px]",
                styles[type].footerText,
              )}
            >
              {cardNumber}
          ...
          <div
            className={cx(
              "w-11.5 flex h-8 shrink-0 items-center justify-center rounded",
