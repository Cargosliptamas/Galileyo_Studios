...
export const affiliateInviteRelations = relations(affiliateInvite, ({one}) => ({
	user: one(user, {
...
export const bpSubscriptionRelations = relations(bpSubscription, ({one, many}) => ({
	user: one(user, {
...
export const contractLineRelations = relations(contractLine, ({one, many}) => ({
	service: one(service, {
...
export const contractLinePaidRelations = relations(contractLinePaid, ({one}) => ({
...
export const conversationFileRelations = relations(conversationFile, ({one}) => ({
...
export const conversationUnviewedRelations = relations(conversationUnviewed, ({one}) => ({
	conversation: one(conversation, {
...
export const conversationUserRelations = relations(conversationUser, ({one}) => ({
	conversation: one(conversation, {
...
export const emailPoolAttachmentRelations = relations(emailPoolAttachment, ({one}) => ({
...
export const followerListRelations = relations(followerList, ({one, many}) => ({
...
export const influencerAssistantRelations = relations(influencerAssistant, ({one}) => ({
	user_idAssistant: one(user, {
...
export const inviteAffiliateRelations = relations(inviteAffiliate, ({one}) => ({
...
export const invoicePromocodeRelations = relations(invoicePromocode, ({one}) => ({
	invoice: one(invoice, {
...
export const moneyTransactionRelations = relations(moneyTransaction, ({one, many}) => ({
	logAuthorizes: many(logAuthorize),
...
export const promocodeInfluencerRelations = relations(promocodeInfluencer, ({one}) => ({
	promocode: one(promocode, {
...
export const providerTwilioCarrierRelations = relations(providerTwilioCarrier, ({one}) => ({
	provider: one(provider, {
...
export const smsPoolPhoneNumberRelations = relations(smsPoolPhoneNumber, ({one}) => ({
...
export const smsPoolReactionRelations = relations(smsPoolReaction, ({one}) => ({
...
export const spsAddUserRequestRelations = relations(spsAddUserRequest, ({one}) => ({
	user: one(user, {
...
export const subscriptionCategoryRelations = relations(subscriptionCategory, ({many}) => ({
	subscriptions: many(subscription),
}));

export const subscriptionWizardRelations = relations(subscriptionWizard, ({one}) => ({
	user: one(user, {
...
export const userFollowerAlertRelations = relations(userFollowerAlert, ({one}) => ({
	user: one(user, {
...
export const userPlanSheduleRelations = relations(userPlanShedule, ({one}) => ({
	contractLine: one(contractLine, {
...
export const userPointSettingsRelations = relations(userPointSettings, ({many}) => ({
	userPointHistories: many(userPointHistory),
}));

export const userSatelliteSubscriptionRelations = relations(userSatelliteSubscription, ({one}) => ({
	subscription: one(subscription, {
...
export const userSubscriptionAddressRelations = relations(userSubscriptionAddress, ({one}) => ({
	subscription: one(subscription, {
