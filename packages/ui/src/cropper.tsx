...
function CropperCropArea({
  ...
  return (
    <CropperPrimitive.CropArea
      ...
      className={cn(
        "border-3 in-[[data-slot=cropper]:focus-visible]:ring-[3px] in-[[data-slot=cropper]:focus-visible]:ring-white/50 pointer-events-none absolute border-white shadow-[0_0_0_9999px_rgba(0,0,0,0.3)]",
        className,
      )}
      {...props}
    />
